...
Graph 2 describes the same as the chart above but shows the difference in range of household values between each racial group. 
Graph 3 describes the distribution between racial groups and the value of their households depending on the market. It is split up into three categories (low, medium and high). 
