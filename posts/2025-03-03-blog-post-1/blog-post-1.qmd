...
Which race has the highest suicide rate? Which gender has a higher suicide rate? After combining gender and race, which race has the highest suicide rate for a single
gender? Which has the lowest? Investigate the underlying reasons.
