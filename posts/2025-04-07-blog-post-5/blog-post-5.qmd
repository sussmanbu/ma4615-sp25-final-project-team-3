...
Geographical Misalignment: The datasets covered overlapping but not identical geographical areas. The original dataset focused on urban regions, while the new dataset encompassed suburban areas. This discrepancy posed challenges in creating a unified dataset without introducing geographical biases.
Temporal Differences: The datasets were collected during different time periods, with the original dataset covering 2015-2020 and the new dataset spanning 2018-2023. This temporal gap complicated trend analyses and required adjustments to account for time-based variations in the housing market.
