...
The Kaggle housing dataset was cleaned using our [cleaning script](/scripts/housing_kaggle_clean.R). This process involved transforming categorical variables and retaining only relevant columns for analysis. The main cleaning steps were:
